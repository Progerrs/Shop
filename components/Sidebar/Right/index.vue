  ...
  <div class="flex flex-col">
    ...
    <div class="relative m-2">
      <div class="absolute flex items-center h-full pl-4 text-gray-600 cursor-pointer">
        <div class="w-6 h-6">
          <icon-serche @click="handleSearch" />
        </div>
      </div>
      <input v-model="search"
             ...
             placeholder="Найти комикс" type="text">
    </div>
    ...
    <SidebarRightPreviewCard title="Top-100">
      <SidebarRightPreviewCardItem v-for="whoToFollow in whoToFollowItems">
        <div class="flex flex-row items-center justify-between p-2">
          ...
          <div class="flex h-full">
            <button
                class="px-4 py-2 text-xs font-bold text-white bg-black rounded-full dark:text-black dark:bg-white">About</button>
          </div>
        </div>
      </SidebarRightPreviewCardItem>
    </SidebarRightPreviewCard>
...
const whoToFollowItems = ref([
  {
    name: 'Joe Biden',
    handle: '@JoeBiden',
    image: 'https://www.hist.msu.ru/Departments/Inf/Stud/IMG/Translat/Planet00.jpg'
  },
  {
    name: 'Joe Biden',
    handle: '@JoeBiden',
